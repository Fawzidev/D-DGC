...
from model_us_air import FR_DGC
from datasets import format_data,sparse_mx_to_torch_sparse_tensor
from model_us_air import clustering_metrics
...
print("US dataset")
nClusters = 4
adj, features , labels = load_data_networks('usa', '/home/mrabah_n/code/FR_DGC/data/Airports/')
